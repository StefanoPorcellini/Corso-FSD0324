...
export class TodoService {
  ...
  filterTodoByUserId(id:number):iTodo[]{
    return this.todoArray.filter(t => t.userId === id)
  }


  filterCompleteTodo(){
    this.todoArray.forEach(t=>{
      const user = this.userSvc.userArray.find(u=>u.id ===t.userId)
      if(user) {
